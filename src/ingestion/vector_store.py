...
class PathwayVectorStore:
    ...
    def initialize(self) -> None:
        ...
        This is called by the ClinicalService during startup to ensure the
        vector store is ready for operations.
        """
        logger.info("Vector store initialization started")
        
        # Verify embedding generator is properly initialized
